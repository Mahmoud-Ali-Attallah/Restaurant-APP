...
async function getData(){
    for( let i = 0 ; data.length < 25 ; i++){
        let Response = await fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${num}`) ;
...
for(let i = 0 ; i < data.length ; i++){
    container+=` <div class="this this col-sm-12  col-xl-6  col-xxl-3 text-white position-relative overflow-hidden  mb-2 ">
...
function showDea(x){
    ...
    // <i class="fa-solid fa-bars fs-1 here" id="here"></i>
